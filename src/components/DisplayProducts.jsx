        ...
        {isModalOpen && selectedProduct && (
          <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
            <motion.div 
              ...
              className="p-6 bg-gray-900 text-white rounded-lg shadow-xl max-w-sm w-full">
              ...
              <form onSubmit={handleSubmit(handleOrder)} className="mt-4">
                ...
                <div className="mt-4 flex justify-between">
                  <button 
                    ...
                    className={`py-2 px-4 ${isSubmitting ? 'bg-gray-500' : 'bg-green-500'} text-white rounded hover:bg-green-600`}>
